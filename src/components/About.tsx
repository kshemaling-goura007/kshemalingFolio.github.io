...
import { Coffee, Leaf, LeafyGreen, Server, SquareParking } from 'lucide-react';
  ...
  const skills = [
    ...
    { icon: Server, name: 'Servlets', level: 87 },
     { icon: Leaf, name: 'Spring', level: 80 },
      { icon: LeafyGreen, name: 'SpringBoot', level: 80 },
      { icon: Database, name: 'MySQL', level: 85 },
    { icon: Globe, name: 'HTML5/CSS3', level: 80 },
    { icon: Code, name: 'JavaScript', level: 70 },
    { icon: Code, name: 'React', level: 50 },
    { icon: Cube, name: 'Bootstrap', level: 50 },
    { icon: GitBranch, name: 'Git', level: 89 },
    { icon: Cube, name: 'GitHub', level: 83 },
    { icon: Database, name: 'PostMan', level: 87 },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Motivated and detail-oriented Electronics and Communication Engineering graduate with a solid foundation 
              in programming and software development. Proficient in C, Java, Advance Java And Web technologies like 
              Html, Css, React(Basics) with hands-on experience. Eager to contribute to organizational success and achieve 
              professional growth in a dynamic and challenging role.
            </p>
