...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      id: 2,
      title: "Blog Application using Spring Boot & React",
      description: "A full Stack blog Application with user authentication, CRUD operations for posts and comments, built with Spring Boot for the backend and React for the frontend.",
      image: "/Images/project-2.jpg",
      tech: ["Spring", "CSS", "React", "MySQL", "JAVA", "HTML"],
      liveUrl: "",
      githubUrl: ""
     ...
     {
      id: 3,
      title: "Bank Management System using Spring Boot & JS",
