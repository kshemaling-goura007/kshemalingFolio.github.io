  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (userInput.includes("services")) {
        reply = "kshem offers services in frontend, backend development, animations, and AI integration. Would you like a portfolio link?";
      } else if (userInput.includes("contact")) {
        reply = "You can contact kshem via the contact form above or email him directly at kshemalinggoura007@gmail.com";
      } else if (userInput.includes("react") || userInput.includes("gsap")) {
        reply = "Yes! kshem uses React, GSAP, and even WebGL to build stunning UIs.";
      } else if (userInput.includes("project")) {
        reply = "Tell me more about your project! kshem can help with frontend, backend, UI/UX design, and building full-stack web applications.";
      }
