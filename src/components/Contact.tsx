...
import { PaperPlaneTilt, GithubLogo, LinkedinLogo, Envelope, Phone, MapPin, InstagramLogo } from 'phosphor-react';
          ...
          <div ref={infoRef} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">kshemalinggoura007@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-secondary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+91 8618319191</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com/kshemaling-goura007/Git-Project" className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
